...
The new goal is different: **we want to see the debugger being used**. We're showcasing what agent-lens enables, not evaluating whether the agent discovers it. So prompts now explicitly invite debugger use.
...
- Skill delivery mechanism (`.claude/skills/agent-lens/SKILL.md` in workspace)
