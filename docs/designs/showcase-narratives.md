...
Filter the timeline to just `debug_*` / `mcp__agent-lens__*` tool calls. This shows:
...
This is the agent-lens pitch: "Here's what runtime debugging looks like for an AI agent."
