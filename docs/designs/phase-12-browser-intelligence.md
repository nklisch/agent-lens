...
```bash
# Diff two moments
agent-lens browser diff <session_id> --before "14:31:45" --after "14:35:22" --include form_state
...
# Export as HAR
agent-lens browser export <session_id> --format har --output session.har
```
...
```bash
agent-lens browser export <session_id> --format har --output session.har
agent-lens browser export <session_id> --format har  # outputs to stdout
```
...
# Manual verification
agent-lens browser diff <session_id> --before "14:31:45" --after "14:35:22"
agent-lens browser replay-context <session_id> --around-marker M1 --format reproduction_steps
agent-lens browser replay-context <session_id> --around-marker M1 --format test_scaffold --framework playwright
agent-lens browser export <session_id> --format har --output test.har
