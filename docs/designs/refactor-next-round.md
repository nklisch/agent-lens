...
- `agent-lens doctor` still reports correct status for all installed adapters
...
- Build passes
- Unit tests pass
- MCP tool descriptions still render correctly (check via `agent-lens mcp` or MCP inspector)
